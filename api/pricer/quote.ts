// Local type shim for @vercel/node (Vercel's Node runtime types) to avoid
// pulling the full package into our deps. The runtime passes standard
// Node IncomingMessage / ServerResponse, this just keeps tsc happy.
